...
int main() {
  ...
  tlinkedlist.InsertLast(shared_ptr<Square>(new Square(Point(1,2),Point(1,3),Point(3,3),Point(3,2))));
  tlinkedlist.InsertLast(shared_ptr<Square>(new Square(Point(11,12),Point(11,13),Point(13,13),Point(13,12))));

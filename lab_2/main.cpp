...
int main() {
  ...
  tlinkedlist.InsertLast(Square(Point(11,12),Point(11,13),Point(12,13),Point(12, 12)));
  tlinkedlist.InsertLast(Square(Point(21,22),Point(21,23),Point(22,23),Point(22,22)));
  tlinkedlist.InsertLast(Square(Point(31,32),Point(31,33),Point(32,33),Point(32,32)));
  cout << tlinkedlist;
